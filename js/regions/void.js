...
const voidData = {
  ...
  existingChampions: [
    ...
    },
    {
      ...
      role: "Đỡ Đòn",
      region: "void",
      lore: "Quái vật khổng lồ của Hư Không với cơn đói bất tận.",
      releaseDate: "26/06/2009",
      loreConnections: ["Kha'Zix", "Kog'Maw", "Vel'Koz"],
      weaponSummary: "Cơ thể",
    },
    {
      id: "khazix",
      ...
      role: "Sát Thủ",
      region: "void",
      lore: "Thợ săn Hư Không tiến hóa thông qua việc giết chóc.",
      releaseDate: "27/09/2012",
      loreConnections: ["Cho'Gath", "Kog'Maw", "Rengar", "Vel'Koz"],
    ...
    },
    {
      ...
      role: "Xạ Thủ",
      region: "void",
      lore: "Sinh vật Hư Không ngây thơ với cơn đói không ngừng.",
      releaseDate: "24/06/2010",
      loreConnections: ["Malzahar", "Kha'Zix", "Cho'Gath", "Vel'Koz"],
    ...
    },
    {
      ...
      role: "Pháp Sư",
      region: "void",
      lore: "Nhà tiên tri bị Hư Không tha hóa, phục vụ sự trở lại của các chủ nhân.",
      releaseDate: "01/06/2010",
      loreConnections: ["Kai'Sa", "Kog'Maw", "Vel'Koz"],
      weaponSummary: "Ma thuật",
    },
    {
      id: "reksai",
      ...
      role: "Đấu Sĩ",
      region: "void",
      lore: "Nữ hoàng hang động săn mồi dưới sa mạc Shurima.",
      releaseDate: "11/12/2014",
      loreConnections: ["Kha'Zix", "Cho'Gath", "Kog'Maw", "Vel'Koz"],
    ...
    },
    {
      ...
      role: "Pháp Sư",
      region: "void",
      lore: "Mắt của Hư Không, quan sát và ghi chép kiến thức trước khi hủy diệt.",
      releaseDate: "27/02/2014",
      loreConnections: ["Kha'Zix", "Cho'Gath", "Kog'Maw", "Rek'Sai"],
      weaponSummary: "Ma thuật",
    },
  ],
  newChampions: [
